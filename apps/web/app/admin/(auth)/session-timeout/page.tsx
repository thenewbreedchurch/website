...
export default function SessionTimeoutPage() {
  ...
  return (
    <AuthCard title="Session Expired" center>
      ...
      <p className="mt-2 text-xs text-neutral-400">Redirecting to sign in in {secondsLeft}s…</p>
      <button
        type="button"
        onClick={() => router.push("/admin/login")}
        className="mt-6 w-full rounded-lg bg-brand-700 px-3 py-2.5 text-sm font-medium text-white transition hover:bg-brand-800"
      >
        Return to sign in
      </button>
    </AuthCard>
