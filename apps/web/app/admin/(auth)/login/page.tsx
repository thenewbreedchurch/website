...
const inputClasses =
  "w-full rounded-lg border border-neutral-300 bg-white px-3.5 py-2.5 text-sm text-neutral-900 focus:border-brand-700 focus:outline-none focus:ring-2 focus:ring-brand-700/25 admin-dark:border-neutral-700 admin-dark:bg-neutral-900 admin-dark:text-neutral-100";
  ...
  return (
    <AuthCard title="Admin Sign In" subtitle="The New Breed Church">
      <form onSubmit={handleSubmit} className="space-y-5" noValidate>
        ...
        <div>
          <label htmlFor="password" className="block text-sm font-medium text-neutral-700 admin-dark:text-neutral-300">
            Password
          </label>
          <input
            id="password"
      ...
      <div className="mt-6 text-center text-sm">
        <Link href="/admin/forgot-password" className="text-brand-700 hover:underline admin-dark:text-brand-300">
