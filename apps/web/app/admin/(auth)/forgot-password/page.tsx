        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          <div>
            ...
            <input
              ...
              className="mt-2 w-full rounded-lg border border-neutral-300 px-3.5 py-2.5 text-sm focus:border-brand-700 focus:outline-none focus:ring-2 focus:ring-brand-700/25"
            />
          </div>
