          ...
          {inquiries.map((inq) => (
            <tr key={inq.id}>
              <Td>
                ...
                <div className="text-xs text-neutral-500 admin-dark:text-neutral-400">{inq.email}</div>
                {inq.phone && <div className="text-xs text-neutral-500 admin-dark:text-neutral-400">{inq.phone}</div>}
              </Td>
              <Td>
