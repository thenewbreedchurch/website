            ...
            <tr key={a.id}>
              ...
              <Td>
                {a.registrationRequired ? (
                  <Link href={`/admin/announcements/${a.id}/registrations`} className="text-brand-700 hover:underline admin-dark:text-brand-300">
              ...
              <Td className="text-right">
                <div className="flex justify-end gap-3">
                  <Link href={`/admin/announcements/${a.id}`} className="text-xs font-medium text-brand-700 hover:underline admin-dark:text-brand-300">
                    Edit
                  </Link>
