...
// an explicit dark: companion, gated by the .dark class from the theme
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-screen flex-col bg-neutral-50 text-neutral-900 [color-scheme:light] dark:bg-neutral-950 dark:text-neutral-100 dark:[color-scheme:dark]">
      {children}
    </div>
  );
}
